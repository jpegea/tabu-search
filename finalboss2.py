...
for inst in instances:
    if inst['n'] == 100:
        s1 = tabusearch.execute(inst, 13000, 20, "random", 0, True)
        s2 = tabusearch.execute(inst, 13000, 20, "random", 0, True)
        ...
        s1 = tabusearch.execute(inst, 380, 20, "random", 0, True)
        s2 = tabusearch.execute(inst, 380, 20, "random", 0, True)
